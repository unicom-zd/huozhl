...
while(ii<cluster_size)
{
	...
	syscmd+=train_name+its(ii);
	syscmd+=" div_test_sam2 -1";
	cout<<syscmd<<endl;system(syscmd.c_str());
	w1<<syscmd<<endl;
	...
	syscmd+=connstring;syscmd+=" "; 
	syscmd+=train_name+its(ii)+" ";
	syscmd+="div_test_sam2 zz_train_clus2 -1";
	cout<<syscmd<<endl;system(syscmd.c_str());
	w1<<syscmd<<endl;
	
	syscmd="./redata table_sort6 table_sort.csv "+username+" "+password+" "+connstring;
	cout<<syscmd<<endl;system(syscmd.c_str());
	w1<<syscmd<<endl;
	...
	syscmd+="div_test_sam2 zz_test1_clus2 -1";
	cout<<syscmd<<endl;system(syscmd.c_str());
	w1<<syscmd<<endl;
